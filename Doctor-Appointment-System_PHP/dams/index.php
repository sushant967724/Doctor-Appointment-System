...
include('doctor/includes/dbconnection.php');
    if(isset($_POST['submit']))
  {
    ...
    $patientDescription = $_POST['patient_description'];
...
if($appdate<=$cdate){
    ...
    $sql = "INSERT INTO tblappointment (AppointmentNumber, UserId, Name, MobileNumber, Email, AppointmentDate, AppointmentTime, Specialization, Doctor, Message, ConsultationType, PatientDescription) VALUES (:aptnumber, :UserId, :name, :mobnum, :email, :appdate, :aaptime, :specialization, :doctorlist, :message, :consultation_type, :patient_description)";
...
$query->bindParam(':consultation_type', $consultation_type, PDO::PARAM_STR);
$query->bindParam(':patient_description', $patientDescription, PDO::PARAM_STR);
...
{               ?>
    ...
    <select name="consultation_type" id="consultation_type" class="form-control" required>
        ...
        <option value="face_to_face">Face-to-Face Consultancy</option>
        <option value="video_call">Video Call Consultancy</option>
        <option value="phone_call">Phone Call Consultancy</option>
    </select>
</div>
...
<div class="col-12">
    <textarea class="form-control" rows="5" id="patient-description" name="patient_description" placeholder="Describe your symptoms or condition"></textarea>
</div>
                                        <div class="col-12">
